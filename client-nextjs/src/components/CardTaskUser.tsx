...
function CardTaskUser({ tasks }: dtoTask | any) {
  ...
  const deleteTask = async (id: number) => {
    ...
    await axiosAuth.delete(`${URI}/tasks/${id}/delete`); 
    // await axios.delete(`${URI}/tasks/${id}/delete`,config);
    location.reload();
    //router.push("/");
    //router.refresh();
    //await getTaskss();
  ...
  const editDoneTask = async (id: number) => {
    ...
    //await axiosAuth.patch(`/tasks/${id}/toggleDone`);

    await axiosAuth.patch(`${URI}/tasks/${id}/toggleDone`,{});
  ...
  return (
    ...
    >
      ...
      <a
        ...
        href={`/interfaces/tasks/${tasks.id}/edit`}
      >
        Edit
      </a>
    </div>
