...
function EditFormTask() {
    ...
    const getTypeTasks = async () => {
      const config = {
        ...
        const res = await axiosAuth.get(`${URI}/type-tasks`)
    ...
    const putEditTasks = async (e:any) => {
        ...
        await axios.put(`${URI}/tasks/${id}/edit`,{title:title,type_task_id:typeTask,done:done,description:description},config)
