...
function RegisterForm() {
  ...
  const [username, setUsername] = useState<number | string | undefined>();
  ...
  const postAuthRegister = async (e: any) => {
    e.preventDefault();
  ...
  */
  ...
  return (
    <div>
      ...
      <form onSubmit={postAuthRegister} className="max-w-md mx-auto">
